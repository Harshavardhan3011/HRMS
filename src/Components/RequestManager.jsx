...
const mockLeaveRequests = [
  { id: "1", userEmail: "employee1@example.com", reason: "Medical leave", status: "Pending" },
  { id: "2", userEmail: "employee2@example.com", reason: "Vacation", status: "Approved" },
  { id: "3", userEmail: "employee3@example.com", reason: "Personal work", status: "Rejected" },
];
...
export default function RequestManager() {
  ...
  return (
    <div className="bg-gradient-to-br from-[#060110] via-[#0b0515] to-[#f40606] p-8 rounded-xl mt-10 shadow-lg max-w-5xl mx-auto text-white">
      <h2 className="text-3xl font-extrabold mb-6 border-b border-green-600 pb-2 text-green-400">Leave Requests</h2>

      {requests.length === 0 ? (
        <p className="text-gray-400 text-center py-10 italic">No leave requests yet.</p>
      ) : (
