...
import { ref, push } from "firebase/database"; // Assuming Firebase is set up
...
export default function EmployeeForm() {
  ...
  return (
    <form
      ...
      className="bg-gradient-to-br from-[#060110] via-[#0b0515] to-[#f40606] p-8 rounded-xl mt-10 max-w-md mx-auto space-y-6 shadow-lg text-white"
    >
