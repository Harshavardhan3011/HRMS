...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-gradient-to-br from-[#060110] via-[#0b0515] to-[#f40606] p-8 rounded-xl shadow-lg text-white">
      <h1 className="text-4xl font-extrabold mb-6">My Profile ({user.role})</h1>
      {message && (
        <p className={`mb-6 ${message.startsWith("Error") ? "text-red-500" : "text-green-400"}`}>{message}</p>
      )}
