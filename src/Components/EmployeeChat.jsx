...
export default function EmployeeChat() {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-[#060110] via-[#0b0515] to-[#f40606] p-6 rounded-lg h-96 overflow-y-auto mb-4 text-white shadow-lg flex flex-col">
        {messages.length === 0 && <p className="text-gray-500 text-center mt-20">No messages yet. Say Hi!</p>}
